...
const Product = ({ post }) => {
    ...
    return (
        <div className="flex flex-col items-center justify-between
         hover:scale-110 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px] 
         gap-3 p-4 mt-10 rounded-xl transition duration-300 ease-in">
            <div>
                <p className="text-gray-700 font-semibold text-lg yext-left truncate w-40 mt-1">{post.title}</p>
            </div>
            <div>
